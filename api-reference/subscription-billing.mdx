...
|------|-------------|-----------------|
| **Free** | $0 | 3 models, basic limits |
| **Paid** | $10 | All 11 models, 100x limits |
...
<CardGroup cols={2}>
  <Card title="View All Models" icon="layer-group" href="/api-reference/models-pricing">
    Compare all 11 models and their pricing
  </Card>
  
  <Card title="API Features" icon="wand-magic-sparkles" href="/api-reference/api-features">
    Learn about streaming, temperature control, and more
  </Card>
